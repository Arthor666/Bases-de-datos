...
<body data-spy="scroll" data-target="#navbar" data-offset="30">
  ...
  <tr>
    ...
    <td>Platicar</td>
    <td>Cafeteria</td>
    <td>25-Octubre-2019</td>
    <td>13:30-15:00</td>
    <td>
        <a href="pagina_principal.html"><input type="button" value="Cancelar" class="btn cancelar_btn" onClick="mi_alerta()"></a>
    </td>
  </tr>
  <tr>
    <td>2</td>
    <td>Jugar</td>
    <td>Sal&oacuten 1202</td>
    <td>31-Octubre-2019</td>
    <td>15:00-16:30</td>
    <td>
        <a href="pagina_principal.html"><input type="button" value="Cancelar" class="btn cancelar_btn" onClick="mi_alerta()"></a>
    </td>
  ...
  <tr>
    <td>1</td>
    <td>Asesor&iacutea</td>
    <td>Jardineras</td>
    <td>30-Octubre-2019</td>
    <td>15:00-16:30</td>
    <td>
        <a href="pagina_principal.html"><input type="button" value="Participar" class="btn participar_btn" onClick="participacion()"></a>
    </td>
  </tr>
</table>
    </div>
